...
class woolydart {
  ...
  void wooly_free_model(
    ...
    ffi.Pointer<llama_model> model_ptr,
  ) {
  ...
  late final _wooly_free_modelPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<llama_context>,
              ffi.Pointer<llama_model>)>>('wooly_free_model');
  ...
  gpt_params_simple wooly_new_params() {
    return _wooly_new_params();
  }

  late final _wooly_new_paramsPtr =
      _lookup<ffi.NativeFunction<gpt_params_simple Function()>>(
          'wooly_new_params');
  late final _wooly_new_params =
      _wooly_new_paramsPtr.asFunction<gpt_params_simple Function()>();

  wooly_predict_result wooly_predict(
    gpt_params_simple simple_params,
    ffi.Pointer<llama_context> ctx_ptr,
    ffi.Pointer<llama_model> model_ptr,
...
final class load_model_result extends ffi.Struct {
  external ffi.Pointer<llama_model> model;

  external ffi.Pointer<llama_context> ctx;
}
...
final class gpt_params_simple extends ffi.Struct {
